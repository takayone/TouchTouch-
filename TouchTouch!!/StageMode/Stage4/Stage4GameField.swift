...
class Stage4GameField: UIViewController{
    ...
    @objc func handleProgressTimer(){
        ...
        if remainedTime < 1{
            ...
            if countNumbers > 99{
                ...
                stageResultController.stageResult = "All Missions Compleated"
                present(stageResultController, animated: true, completion: nil)
            }else{
                let stageResultController = StageResultController()
                stageResultController.stageResult = "Stage3 Clear"
                present(stageResultController, animated: true, completion: nil)
