//
//  Stage3GameField.swift
//  TouchTouch!!
//
//  Created by takahitoyoneda on 2018/09/09.
//  Copyright © 2018 takahitoyoneda. All rights reserved.
//

import UIKit

class Stage3GameField: UIViewController{
    
    var countDownTimer = Timer()
    var remainedTime : Int = 5
    ...
    @objc func handleProgressTimer(){
        ...
        if remainedTime < 1{
            ...
            if countNumbers > 39{
                let stage4StartController = Stage4StartController()
                present(stage4StartController, animated: true, completion: nil)
            }else{
                let stageResultController = StageResultController()
                stageResultController.stageResult = "Stage2 Clear"
